...
setup(
    ...
    url='https://github.com/thatmabd/cliops',
    project_urls={
        'Bug Reports': 'https://github.com/thatmabd/cliops/issues',
        'Source': 'https://github.com/thatmabd/cliops',
        'Documentation': 'https://cliops.fun/docs',
    },
